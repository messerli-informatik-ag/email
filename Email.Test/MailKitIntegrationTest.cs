...
namespace Messerli.Email.Test
{
    public sealed class MailKitIntegrationTest
    {
        ...
        private static readonly MailboxAddress ToAddress = new MailboxAddress("to@localhost");

        private static readonly MailboxAddress CcAddress = new MailboxAddress("cc@localhost");

        private static readonly MailboxAddress BccAddress = new MailboxAddress("bcc@localhost");
        ...
        public static TheoryData<string, EmailMessage> GetEmailMessagesData()
            => new TheoryData<string, EmailMessage>
            {
                ...
                },
                {
                    "EmailWithHtmlBody",
                    EmailMessageBuilderWithoutContent
                        .AddBodyPart(new Html("<h1>Hello World.</h1><p>this is a test.</p>"))
                        .Build()
                },
                {
                    ...
                    EmailMessageBuilderWithoutContent
                        .AddBodyPart(new Alternatives(
                            new Plain("Hello World. This is a test."),
                            new Html("<h1>Hello World.</h1><p>this is a test.</p>")))
                        .Build()
                },
                {
                    "EmailWithAttachment",
                    EmailMessageBuilderWithoutContent
                        .AddBodyPart(new Plain("This is art"))
